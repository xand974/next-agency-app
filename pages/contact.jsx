  ...
  return (
    <div className="flex items-center justify-center mb-10 pb-10 relative overflow-hidden border-b-custom">
      ...
      <div className="flex flex-col">
        ...
        <form className="flex flex-wrap w-5/12 mx-auto">
          {inputs.map((item) => (
            <input
              key={item.id}
              type={item.type}
              ...
              name={item.name}
              className="input-size p-3 outline-none border-default m-2 font-mono"
            />
          ))}
          <textarea
            placeholder="votre message..."
            className="w-full p-3 border-default m-2 resize-none font-mono"
            name="message"
            id=""
            cols="30"
            rows="10"
